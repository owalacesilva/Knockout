 ...
 *
 */
public class OpponentHandRight extends AnimatedSprite implements IOpponentParts {
	 ...
	 */
	public OpponentHandRight(float pX, float pY, ITiledTextureRegion tiledTexture) {

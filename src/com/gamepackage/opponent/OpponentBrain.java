 ...
 *
 */
public class OpponentBrain extends AnimatedSprite implements IOpponentParts {
	
	private PhysicsHandler physicsHandler; 

	public OpponentBrain(float pX, float pY, ITiledTextureRegion tiledTexture) {
	...
	public void preparedAnimation() {
		IEntityModifier entityModifier = new LoopEntityModifier(
				new SequenceEntityModifier(
						new JumpModifier(1.9f, getX(), getX(), getY(), getY(), -20.5f)
				)
		);
